...
for status_icon in CodexStatusIcon.png ClaudeStatusIcon.png; do
    if [[ -f "$project_root/Resources/$status_icon" ]]; then
        cp "$project_root/Resources/$status_icon" "$output_app/Contents/Resources/$status_icon"
    fi
done
