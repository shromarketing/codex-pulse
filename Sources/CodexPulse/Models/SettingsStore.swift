...
final class SettingsStore: ObservableObject {
    ...
    @Published var resetSignalChecksEnabled: Bool { didSet { set(resetSignalChecksEnabled, Keys.resetSignalChecksEnabled) } }
    ...
    private enum Keys {
        ...
        static let resetSignalChecksEnabled = "resetSignals.enabled"
    ...
    private init() {
        ...
        resetSignalChecksEnabled = defaults.object(forKey: Keys.resetSignalChecksEnabled) as? Bool ?? true
